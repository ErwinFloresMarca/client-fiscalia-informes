    ...
    async downloadPdf() {
      ...
      if (this.previewModal) {
        ...
        if (this.beforePreview) {
          html2PdfSetup2 = this.beforePreview(html2PdfSetup);
        }
        this.pdfFile = html2PdfSetup2 ? await html2PdfSetup2.output('bloburl') : await html2PdfSetup.output('bloburl');
