    ...
    <!-- <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('newContactos')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="cantNewContactos" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('viajes')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="cantViajes" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('noticias')">
